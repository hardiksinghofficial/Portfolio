...
import AyushImg from "@/public/Hardik.jpg";
import AyushImg2 from "@/public/Hardik2.jpg";
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3">
                        <h1 className="text-4xl sm:text-6xl font-bold ">
                            Hey, I&apos;m <span className='text-[#e8390d]'>Hardik</span>
                        </h1>
                        <span
                    ...
                    <p className={` ${jetbrainsMono.className} flex items-center mt-4 text-[#dd431d] gap-2 text-sm sm:text-lg text-right`}> <MapPin /> Satna, India • +91 9407426881</p>

                    <span className="tailwind-wrapper mt-4 text-lg sm:text-3xl font-medium block text-left text-zinc-800 dark:text-zinc-200">
                        <Typewriter
                            options={{
                                strings: ['JAVA FULL-STACK DEVELOPER', 'SPRING BOOT & MICROSERVICES EXPERT', 'REACT DEVELOPER'],
                                autoStart: true,
                                loop: true,
                                delay: 20,
                                deleteSpeed: 5,
